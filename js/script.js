...
async function loadProducts() {
    // Load sample products directly (no backend needed)
    loadSampleProducts();
}
...
function updateLoginButton() {
    ...
    if (loginBtn && loginText) {
        if (currentUser) {
            // Show "My Account" instead of phone number
...
async function handlePhoneLogin(e) {
    ...
    if (!otpSent) {
        ...
        // Verify OTP - Accept any OTP for now
        ...
        setTimeout(() => {
            // Accept any OTP - no verification
            currentUser = {
                phone: fullPhone,
                email: '',
                fullName: '',
...
function showUserMenu() {
    if (currentUser) {
        ...
        modalContent.innerHTML = `
            <h3 style="margin: 0 0 1.5rem 0; color: #333; font-size: 1.3rem;">Account Information</h3>
            <div style="margin-bottom: 1rem;">
                <p style="margin: 0 0 0.3rem 0; color: #666; font-size: 0.9rem;"><strong>Phone:</strong></p>
                <p style="margin: 0; color: #333; font-size: 1rem;">${currentUser.phone}</p>
            </div>
            <div style="margin-bottom: 1.5rem;">
                <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 0.3rem;">
                    <p style="margin: 0; color: #666; font-size: 0.9rem;"><strong>Address:</strong></p>
                    <button id="editAddressBtn" style="
                        ...
                        cursor: pointer;
                        font-size: 0.85rem;
                    ">${currentUser.address ? 'Edit' : 'Add'} Address</button>
                </div>
                <p style="margin: 0; color: #333; font-size: 0.95rem; font-style: ${currentUser.address ? 'normal' : 'italic'};">${addressStr}</p>
            </div>
...
function showAddressModal() {
    ...
    modalContent.innerHTML = `
        <h3 style="margin: 0 0 1.5rem 0; color: #333; font-size: 1.3rem;">${currentUser.address ? 'Edit' : 'Add'} Address</h3>
        <form id="addressForm">
            <textarea 
                id="addressInput" 
            ...
            <div style="display: flex; gap: 1rem;">
                <button type="submit" style="
                    ...
                    font-size: 1rem;
                ">Save Address</button>
                <button type="button" id="cancelAddressBtn" style="
                    flex: 1;
                    padding: 0.75rem;
                    background: #e0e0e0;
                    color: #333;
